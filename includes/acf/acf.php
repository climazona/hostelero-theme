...
class ACF {
	...
	function initialize() {
		...
		$this->define( 'ACF_PATH', get_template_directory() . '/includes/acf/' );
		$this->define( 'ACF_BASENAME', get_template_directory() . '/includes/acf/' );
		...
		$this->settings = array(
			...
			'path'						=> ACF_PATH,
			'file'						=> __FILE__,
			'url'						=> get_template_directory() . '/includes/acf/',
			'show_admin'				=> true,
			'show_updates'				=> true,
			'stripslashes'				=> false,
			'local'						=> true,
