...
<div class="py-5 bg-secundario">
    <div class="container">
        ...
        <p>Artículos de interés del sector.</p>
    </div>
    <div class="container">
        <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            setup_postdata( $post ); ?>
            <div class="col">
                <div class="card h-100 efecto-shadow position-relative">
...
<div class="container">
    <div class="row row-cols-1 row-cols-md-4 g-4">
        <?php
        global $post;
        $args = array( 'posts_per_page' => 4, 'offset'=> 3, 'order'=> 'DEC', 'orderby' => '' );
        $postslist = get_posts( $args );
        foreach ( $postslist as $post ) :
        setup_postdata( $post ); ?>
        <div class="col">
...
<div class="d-grid gap-2 col-6 mx-auto mt-3">
    <a class="btn btn-outline-primary" href="/publicaciones-blog/" role="button">Ver todas las publicaciones</a>
</div>
<div class="container my-3">
    <div class="row">
        <div class="col-12 col-lg-6">
            <div class="card rounded-3 mb-3 d-block tarjeta-info-blog">
                <div class="card-body">
                    <div class="card-title h4">Somos tu blog de climatización</div>
                    <!--<h2 class="h4">Somos tu portal de noticias de climatización</h2>-->
                    <p><strong>Somos el blog ideal</strong> para profesionales y usuarios finales, para todos los temas relacionados con la climatización.</p>
                    <p>En cooperación con varios profesionales del sector, publicamos excelentes <strong>tutoriales y artículos de interés.</strong></p>
                    <p>Además, puedes descubrir y aprender mucho sobre el sector y sus productos, <strong>¡siempre a la última!</strong>.</p>
